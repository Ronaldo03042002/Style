...
conn.on('message-new', async (m) => {
  ...
  if (text.includes('.owner')) {
    conn.sendMessage(id, { displayname: "Ronaldo", vcard: vcard }, MessageType.contact, { quoted: m })
  }
...
Zulu = zu` , MessageType.text, { quoted: m });
  ...
  if (text.includes('ana')) {
    conn.sendMessage(id, 'Repita o comando em minúsculas \ n_exemplo: .bot como vai você_', MessageType.text, { quoted: m });
  }
  if (text.includes("ana")) {
    const teks = text.replace(/ana /, "")
